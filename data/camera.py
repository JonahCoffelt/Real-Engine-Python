...
class Camera:
    ...
    def rotate(self):
        ...
        if self.paused:
            self.paused = False
            return
        self.yaw += rel_x * config['controls']['sensitivity'] / 10
        self.pitch -= rel_y * config['controls']['sensitivity'] / 10
    ...
    def get_projection_matrix(self):
        return glm.perspective(glm.radians(config['graphics']['FOV']), self.aspect_ratio, NEAR, config['graphics']['far_plane_distance'])
