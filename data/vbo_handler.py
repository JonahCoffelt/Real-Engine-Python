...
class VBOHandler:
    def __init__(self, ctx):
        ...
        self.vbos['d4'] = ModelVBO(self.ctx, 'objects/d4/d4.obj')
        self.vbos['d6'] = ModelVBO(self.ctx, 'objects/d6/d6.obj')
        self.vbos['d20'] = ModelVBO(self.ctx, 'objects/d20/d20.obj')
...
class ModelVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        ...
        #objs = pywavefront.Wavefront(self.path, cache=True, parse=True)
        #materials = list(objs.materials.values())
        ##obj = objs.materials.popitem()[1]
        #vertex_data = materials[0].vertices
        #for obj in materials[1:]:
        #    vertex_data += obj.vertices
        #vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data